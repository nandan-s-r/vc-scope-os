...
def run(context_data):
    system_prompt = """You are an elite early-stage VC focused on Founder Psychology.
Analyze the startup context and evaluate founder-market fit, execution velocity, and potential red flags in team dynamics.
