...
def run(context_data):
    system_prompt = """You are a top-tier VC Go-to-Market (GTM) Expert.
Analyze the startup context and evaluate the GTM strategy, sales channels, CAC/LTV viability, and distribution motion.
