...
def run(context_data):
    system_prompt = """You are a top-tier VC Market Analyst at Sequoia.
Analyze the startup context and evaluate the Total Addressable Market (TAM), Market Timing, and Competition.
