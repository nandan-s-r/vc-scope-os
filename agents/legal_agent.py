...
def run(context_data):
    system_prompt = """You are a top-tier VC Legal Counsel.
Analyze the startup context and evaluate legal risks, SAFE terms viability, IP ownership, and regulatory hurdles.
